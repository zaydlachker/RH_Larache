...
export const translations: Record<string, Record<string, string>> = {
  fr: {
    ...
    ou: 'OU',
    info_placeholder_prefix: 'Informations sur',
    info_placeholder_suffix: 'Cette section sera bientôt enrichie de contenus détaillés concernant les services de la commune de Larache.',
    doc_budget_title: 'Loi des communes Dahir',
    doc_budget_desc: '113.14',
    doc_rapport_title: 'Statut fonction publique Décret',
    doc_rapport_desc: '1.58.008',
    doc_plan_title: 'Concours recrutement public',
    doc_plan_desc: '2.11.621',
    doc_reglement_title: 'medecin',
    doc_reglement_desc: '113.14',
    doc_rapport_2025_title: 'infermier',
    doc_rapport_2025_desc: 'BO_6616_AR.pdf',
    doc_plan_strat_title: 'veritinaire',
    doc_plan_strat_desc: '2.11.621',
  ...
  ar: {
    ...
    ou: 'أو',
    info_placeholder_prefix: 'معلومات حول',
    info_placeholder_suffix: 'سيتم إثراء هذا القسم قريباً بمحتوى مفصل يتعلق بخدمات جماعة العرائش.',
    doc_budget_title: 'ظهير قانون الجماعات',
    doc_budget_desc: '113.14',
    doc_rapport_title: 'مرسوم النظام الأساسي للوظيفة العمومية',
    doc_rapport_desc: '1.58.008',
    doc_plan_title: 'مباراة التوظيف العمومي',
    doc_plan_desc: '2.11.621',
    doc_reglement_title: 'طبيب',
    doc_reglement_desc: '113.14',
    doc_rapport_2025_title: 'ممرض',
    doc_rapport_2025_desc: 'BO_6616_AR.pdf',
    doc_plan_strat_title: 'بيطري',
    doc_plan_strat_desc: '2.11.621',
