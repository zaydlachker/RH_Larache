...
export const translations: Record<string, Record<string, string>> = {
  fr: {
    ...
    doc_budget_title: 'Notation des fonctionnaires',
    doc_budget_desc: 'BO_5379_AR.pdf',
    doc_rapport_title: 'Évaluation des fonctionnaires',
    doc_rapport_desc: 'BO_5394_AR.pdf',
    doc_plan_title: 'Promotion fonctionnaires',
    doc_plan_desc: 'BO_4736_AR.pdf',
    doc_reglement_title: 'medecin',
    doc_reglement_desc: 'BO_5379_AR.pdf',
    doc_rapport_2025_title: 'infermier',
    doc_rapport_2025_desc: 'BO_6616_AR.pdf',
    doc_plan_strat_title: 'veritinaire',
    doc_plan_strat_desc: 'BO_4736_AR.pdf',
  ...
  ar: {
    ...
    doc_budget_title: 'تنقيط الموظفين',
    doc_budget_desc: 'BO_5379_AR.pdf',
    doc_rapport_title: 'تقييم الموظفين',
    doc_rapport_desc: 'BO_5394_AR.pdf',
    doc_plan_title: 'ترقية الموظفين',
    doc_plan_desc: 'BO_4736_AR.pdf',
