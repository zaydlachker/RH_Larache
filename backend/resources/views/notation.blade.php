    ...
    <div class="container">
      ...
      <table>
        ...
        <tr>
          ...
          <td colspan="2">{{ isset($fonctionnaire->date_naissance) ? $fonctionnaire->date_naissance->format('d/m/Y') : '' }}</td>
          <td>مكان الازدياد</td>
        ...
        <tr>
          ...
          <td colspan="2">{{ isset($fonctionnaire->date_recrutement) ? $fonctionnaire->date_recrutement->format('d/m/Y') : '' }}</td>
          <td>رقم ب.ت.و</td>
        ...
        <tr>
          ...
          <td colspan="3">{{ isset($fonctionnaire->date_titularisation) ? $fonctionnaire->date_titularisation->format('d/m/Y') : (isset($fonctionnaire->date_recrutement) ? $fonctionnaire->date_recrutement->format('d/m/Y') : '') }}</td>
        </tr>
        <tr>
