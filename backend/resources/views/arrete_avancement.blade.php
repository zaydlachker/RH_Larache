...
<body>
    ...
    <div class="title">
        <div>بطاقة الترشيح لأجل الترقي بالاختيار إلى درجة <span class="dotted-line">{{ $contenu['nouveau_grade'] ?? '.........................' }}</span> برسم سنة <span style="font-weight: bold;">{{ $contenu['annee'] ?? \Carbon\Carbon::now()->year }}</span></div>
    ...
    <div class="section">
        ...
        <div class="data-row">
            ...
            <span class="value">{{ $fonctionnaire->date_naissance ? $fonctionnaire->date_naissance->format('d/m/Y') : '---' }} بـ {{ $fonctionnaire->lieu_naissance ?? '........' }}</span>
        </div>
        <div class="data-row">
    ...
    <div class="section">
        ...
        <div class="data-row">
            ...
            <span class="value">{{ $fonctionnaire->date_recrutement ? $fonctionnaire->date_recrutement->format('d/m/Y') : '---' }}</span>
        </div>
